...
{
    internal class JavaDeviceFeatureMomentaryButton : DeviceFeatureMomentaryButton<JavaDeviceFeatureConfig, SerialDataSource>
    {

        public JavaDeviceFeatureMomentaryButton(JavaDeviceFeatureConfig deviceFeatureConfig) : base(deviceFeatureConfig)
        {
        }
